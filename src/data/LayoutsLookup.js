export const LayoutsLookup = [
  ...
  },
  {
    ...
    colours: {
      background: ["#202224", "Background Colour"],
      mainText: ["#f7f5f3", "Username Colour"],
      subText: ["#f7f5f3", "Bio Colour"],
    },
    buttonTypes: [],
  ...
  },
  {
    ...
    colours: {
      background: ["#c68a4e", "Background Colour"],
      mainText: ["#c68a4e", "Welcome Colour"],
      subText: ["#202224", "Intro Colour"],
    },
    buttonTypes: [],
  },
];
