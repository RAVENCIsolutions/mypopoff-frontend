  ...
  return (
    <main className="pb-6 relative flex-grow flex flex-col items-between justify-between gap-4 md:gap-2 min-h-min">
      ...
      >
        ...
        <section
          className={`md:self-end flex flex-col md:flex-row items-center gap-4`}
        >
          <button
            className={`py-1 flex items-center justify-center border-b-[1px] border-transparent hover:border-stone-500 w-full md:w-auto text-stone-500 transition-all duration-300`}
          >
            Skip Onboarding
          </button>

          <button
            className="px-8 py-2 md:self-end flex items-center justify-center gap-2 hover:gap-4 border-2 border-action bg-transparent hover:bg-action w-full md:w-auto md:rounded-full text-action hover:text-primary-light font-bold transition-all duration-300"
            onClick={nextPage}
          >
