...
const ExploreSingle = ({ theUser }) => {
  return (
    ...
    >
      ...
      <div
        className={`pb-2 bottom-0 -translate-y-16 3xs:group-hover:-translate-y-[99%] left-0 flex flex-col w-full bg-dashboard-primary-light dark:bg-dashboard-primary-dark rounded-tl-2xl transition-all duration-300 z-10`}
      >
        {/* Above the cut */}
        <section className={`px-2 py-1 flex flex-row items-center gap-2 h-16`}>
          <div
