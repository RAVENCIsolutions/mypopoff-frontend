  ...
  return (
    <svg viewBox="0 0 400 400">
      <path
        ...
        onClick={() => props.handleColorChange(props.segments[0])}
      ...
      <path
        ...
        onClick={() => props.handleColorChange(props.segments[1])}
      ...
      <path
        ...
        onClick={() => props.handleColorChange(props.segments[2])}
      ...
      <path
        ...
        onClick={() => props.handleColorChange(props.segments[3])}
      ...
      <path
        ...
        onClick={() => props.handleColorChange(props.segments[4])}
      ...
      <path
        ...
        onClick={() => props.handleColorChange(props.segments[5])}
      ...
      <path
        ...
        onClick={() => props.handleColorChange(props.segments[6])}
      ...
      <path
        ...
        onClick={() => props.handleColorChange(props.segments[7])}
      ...
      <path
        ...
        onClick={() => props.handleColorChange(props.segments[8])}
      ...
      <path
        ...
        onClick={() => props.handleColorChange(props.segments[9])}
      ...
      <path
        ...
        onClick={() => props.handleColorChange(props.segments[10])}
      ...
      <path
        ...
        onClick={() => props.handleColorChange(props.segments[11])}
