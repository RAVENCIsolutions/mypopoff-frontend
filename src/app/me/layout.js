      ...
      <html lang="en" className="dark" suppressHydrationWarning>
        ...
        <body className="p-0 sm:p-6 flex flex-col sm:flex-row items-stretch w-full h-screen min-h-fit bg-primary-light dark:bg-primary-dark">
          <Providers>
            ...
            <section className="ml-0 sm:ml-6 flex flex-col w-full h-full">
              <main className="w-full h-full bg-dashboard-primary-light dark:bg-dashboard-primary-dark rounded-none md:rounded-3xl shadow-xl shadow-black/5 lg:shadow-black/20 sm:overflow-hidden">
                {children}
              </main>
            </section>
          </Providers>
