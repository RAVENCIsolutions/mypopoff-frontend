    ...
    <main className="mx-auto flex flex-col items-start justify-start overflow-hidden w-full max-w-windowed">
      ...
      <section className="px-5 lg:px-14 text-primary-dark dark:text-primary-light/80">
        ...
        <p className="text-base md:text-lg mb-4">
          ...
          and any related services provided by <strong>My Pop Off</strong>.
        </p>
        <p className="text-base md:text-lg mb-4">
          By accessing{" "}
          <Link
          ...
          using any other services provided by <strong>My Pop Off</strong>.
        </p>
        <p className="text-base md:text-lg mb-4">
          We, <strong>My Pop Off</strong>, reserve the right to review and amend
        ...
        <ul className="ml-8 mb-4 list-disc">
          ...
          <li className="text-base md:text-lg mb-2">
            ...
            service <strong>My Pop Off</strong> provides;
          </li>
          <li className="text-base md:text-lg mb-2">
        ...
        <p className="text-base md:text-lg mb-4">
          ...
          are owned by or licensed to <strong>My Pop Off</strong> and are
        ...
        <p className="text-base md:text-lg mb-4">
          ...
          <strong>My Pop Off</strong> at any time.
        </p>
        <h2 className="mt-8 mb-4 text-lg md:text-2xl font-bold">
        ...
        <h2 className="mt-8 mb-4 text-lg md:text-2xl font-bold">Liability</h2>
        <p className="text-base md:text-lg mb-4">
          Our website and the materials on our website are provided on an 'as
          is' basis. To the extent permitted by law, <strong>My Pop Off</strong>{" "}
        ...
        <p className="text-base md:text-lg mb-4">
          In no event shall <strong>My Pop Off</strong> or its suppliers be
          ...
          the materials on this website, even if <strong>My Pop Off</strong> or
        ...
        <p className="text-base md:text-lg mb-4">
          ...
          for general information purposes only. <strong>My Pop Off</strong>{" "}
        ...
        <h2 className="mt-8 mb-4 text-lg md:text-2xl font-bold">Links</h2>
        <p className="text-base md:text-lg mb-4">
          <strong>My Pop Off</strong> has not reviewed all of the sites linked
          ...
          approval or control by <strong>My Pop Off</strong> of the site. Use of
        ...
        <h2 className="mt-8 mb-4 text-lg md:text-2xl font-bold">Severance</h2>
        <p className="text-base md:text-lg mb-4">
