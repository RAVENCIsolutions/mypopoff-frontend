...
export default function TermsAndConditions() {
  return (
    <main className="flex flex-col items-center justify-start overflow-hidden">
      <NavBar />
      <h2>My Pop Off Terms of Service</h2>
      <p>
        These Terms of Service govern your use of the website located at{" "}
        <a href="https://mypopoff.com">https://mypopoff.com</a> and any related
        services provided by My Pop Off.
      </p>
      <p>
        By accessing <a href="https://mypopoff.com">https://mypopoff.com</a>,
        ...
        using any other services provided by My Pop Off.
      </p>
      <p>
        We, My Pop Off, reserve the right to review and amend any of these Terms
      ...
      <p>These Terms of Service were last updated on 29 November 2023.</p>
      ...
      <p>
        ...
        owned by or licensed to My Pop Off and are protected by applicable
      ...
      <p>
        ...
        restrictions or the Terms of Service, and may be terminated by My Pop
        Off at any time.
      </p>
      ...
      <p>
        ...
        basis. To the extent permitted by law, My Pop Off makes no warranties,
      ...
      <p>
        In no event shall My Pop Off or its suppliers be liable for any
        ...
        on this website, even if My Pop Off or an authorized representative has
      ...
      <p>
        ...
        general information purposes only. My Pop Off does not warrant or make
      ...
      <h3>Links</h3>
      <p>
        My Pop Off has not reviewed all of the sites linked to its website and
        is not responsible for the contents of any such linked site. The
        inclusion of any link does not imply endorsement, approval or control by
        My Pop Off of the site. Use of any such linked site is at your own risk
