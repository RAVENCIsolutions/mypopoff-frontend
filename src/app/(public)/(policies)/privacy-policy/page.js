    ...
    <main className="mx-auto flex flex-col items-start justify-start overflow-hidden w-full max-w-windowed">
      ...
      <section className="px-5 lg:px-14 text-primary-dark dark:text-primary-light/80">
        ...
        <p className="text-base md:text-lg mb-4">
          Your privacy is important to us. It is <strong>My Pop Off</strong>'s
        ...
        <p className="text-base md:text-lg mb-4">
          This policy is effective as of <strong>29 November 2023</strong>
        </p>
        <p className="text-base md:text-lg mb-4">
          Last updated: <strong>29 November 2023</strong>
        </p>
        ...
        <h2 className="mt-8 mb-4 text-lg md:text-2xl font-bold">Log Data</h2>
        <p className="text-base md:text-lg mb-4">
        ...
        <h2 className="mt-8 mb-4 text-lg md:text-2xl font-bold">Device Data</h2>
        <p className="text-base md:text-lg mb-4">
        ...
        <ul className="ml-8 mb-4 list-disc">
          <li className="text-base md:text-lg mb-2">Device type</li>
          <li className="text-base md:text-lg mb-2">Operating system</li>
          <li className="text-base md:text-lg mb-2">
            Unique device identifiers
          </li>
          <li className="text-base md:text-lg mb-2">Device settings</li>
        </ul>
        <p className="text-base md:text-lg mb-4">
        ...
        <ul className="ml-8 mb-4 list-disc">
          <li className="text-base md:text-lg mb-2">Email</li>
          <li className="text-base md:text-lg mb-2">Social media profiles</li>
        </ul>
        <h2 className="mt-8 mb-4 text-lg md:text-2xl font-bold">
        ...
        <ul className="ml-8 mb-4 list-disc">
          <li className="text-base md:text-lg mb-2">Register for an account</li>
          <li className="text-base md:text-lg mb-2">
        ...
        <h3 className="mt-6 mb-2 text-lg md:text-xl font-bold">
        ...
        <ul className="ml-8 mb-4 list-disc">
          <li className="text-base md:text-lg mb-2">Google Analytics</li>
          <li className="text-base md:text-lg mb-2">MailChimp</li>
        </ul>
        <h2 className="mt-8 mb-4 text-lg md:text-2xl font-bold">
        ...
        <h3 className="mt-6 mb-2 text-lg md:text-xl font-bold">Do Not Track</h3>
        <p className="text-base md:text-lg mb-4">
        ...
        <h2 className="mt-8 mb-4 text-lg md:text-2xl font-bold">Contact Us</h2>
        <p className="text-base md:text-lg mb-4">
