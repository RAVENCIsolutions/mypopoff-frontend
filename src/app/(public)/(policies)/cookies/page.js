...
export default function CookiesPolicy() {
  return (
    <main className="flex flex-col items-center justify-start overflow-hidden">
      <NavBar />
      <h2>My Pop Off Cookie Policy</h2>
      <p>Effective Date: 29 November 2023</p>
      <p>
        We use cookies to help improve your experience of our website at{" "}
        <a href="https://mypopoff.com">https://mypopoff.com</a>. This cookie
        policy is part of My Pop Off's privacy policy. It covers the use of
      ...
      <p>
        ...
        <a href="https://mypopoff.com">https://mypopoff.com</a>. In such a case,
      ...
      <p>
        ...
        &quot;help&quot; section). If you choose to refuse or disable cookies
        you may still use the Website, though some of the functionality of the
