...
export default function OnBoardingLayout({ children }) {
  return (
    <main className="relative px-2 sm:px-5 py-8 mx-auto flex flex-col w-full min-h-fit md:min-h-screen bg-primary-light dark:bg-primary-light dark:text-primary-dark">
